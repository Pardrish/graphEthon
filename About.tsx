            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="space-y-4 text-gray-600">
                  <p>
                    SafetyNet was founded in 2020 with a simple but powerful vision: to leverage technology to create safer neighborhoods where everyone feels secure and connected.
                  </p>
                  <p>
              ...
              >
                <img
                  src="https://images.unsplash.com/photo-1577351594944-8d3b1eba9578?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
